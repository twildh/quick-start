...
const Header = (props: Props): ReactElement => {
	...
	const parentFolderId = currentFolderId ? bookmarks[currentFolderId].parentId : undefined;
	const grandParentFolderId = parentFolderId ? bookmarks[parentFolderId].parentId : undefined;
