 ...
 */
const getChildren = (bookmarks: FlatTree, currentFolder: TreeNode): TreeNode[] =>
...
const FolderView = (props: Props): ReactElement => {
	...
	const [children, setChildren] = useState<TreeNode[]>(getChildren(bookmarks, currentFolder));
	...
	const folderView =
		children.length > 0 ? (
			<div className={styles.treeContainer}>
				...
				<ContextMenu contextMenuInfo={contextMenuInfo} setDialogInfo={setDialogInfo} />
			</div>
		) : (
