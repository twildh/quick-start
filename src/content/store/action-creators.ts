...
export function setCurrentFolderId(currentFolderId: NodeId): SetCurrentFolderIdAction {
	return {
...
export function setDraggedNodeId(draggedNodeId: NodeId | undefined): SetDraggedNodeIdAction {
	return {
